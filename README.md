...
V0.1 is the **web app shell and accounts**. Playback is not wired yet.
...
| After sign-in | Home, Library (empty shelf), Settings, player dock (disabled) |
| Playback | Not in V0.1 — next |
| Formats (goal) | MP3, FLAC, Opus |
